    ...
    return (
        <div>
            <div className="container">
                <h1 className="justify-content-center text-center mt-5 display-3 font-weight-bold">We are Earth Trek</h1>
                <p className="mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos nihil explicabo sunt laboriosam ex facere dolores error voluptatibus accusantium aliquam, commodi, hic molestias a reprehenderit aut non officia quibusdam earum.</p>
